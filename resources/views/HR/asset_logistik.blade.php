...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">GA - Logistik</li>
  </ol>
</section>
    ...
    <div class="box-body">
      <div class="nav-tabs-custom active" id="asset" role="tabpanel">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active home-tab" id="home-tab" data-toggle="tab" style="display: none;" href="#peminjaman_asset_logistik" role="tab" aria-controls="home" aria-selected="true">Request Logistik - Facilities</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active home-tab-2" id="home-tab-2" data-toggle="tab" style="display: none;" href="#peminjaman_asset_logistik_2" role="tab" aria-controls="home" aria-selected="true">Request Logistik - Requestor</a>
          </li>
                ...
                <tbody id="products-list" name="products-list">
                  ...
                  <tr>
                    ...
                    <td id="col_action_2" class="col_action" style="display: none;">
                      <a href="{{url('/asset_logistik/detail_asset_logistik', $data->id_barang) }}"><button class="btn btn-xs btn-primary" style="width:35px;height:30px;border-radius: 25px!important;outline: none;"><i class="fa fa-history" aria-hidden="true" data-toggle="tooltip" title="History" data-placement="bottom"></i></button></a>
                  ...
                  @foreach($request as $data)
                    <tr>
                      ...
                      <td>
                        ...
                        <button class="btn btn-xs btn-success" id="btn_accept_request_logistik" value="{{$data->id_barang}}" name="btn_accept" style="width: 90px; height: 25px;">ACCEPT</button>
                        <button class="btn btn-xs btn-danger" id="btn_reject" name="btn_reject" style="width: 90px; height: 25px;" onclick="reject_request_logistik('{{$data->id_barang}}')">REJECT</button>
                        @elseif($data->status == 'PROCESS')
                        <button class="btn btn-xs btn-primary" id="btn-done" data-target="#done_request_modal" data-toggle="modal" name="btn_done" style="width: 90px; height: 25px" onclick="done_request_logistik('{{$data->id_barang}}', '{{$data->nama}}', '{{$data->qty}}', '{{$data->nik}}', '{{$data->keterangan}}')">DONE</button>
                        @elseif($data->status == 'DONE')
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Add Asset Logistik</h4>
        </div>
...
<div class="modal fade" id="modalrestock" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Update Stok Logistik</h4>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="peminjaman_modal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Request Logistik</h4>
        </div>
        <div class="modal-body">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" id="btn_accept_logistik" class="btn btn-xs btn-success" style="width: 70px; height: 25px;"><i class="fa fa-check"></i>&nbsp Accept</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-xs btn-default" style="width: 70px; height: 25px;" data-dismiss="modal"><i class="fa fa-times"></i>&nbspCANCEL</button>
            <button type="submit" id="btn_reject_logistik" class="btn btn-xs btn-danger" style="width: 70px; height: 25px;"><i class="fa fa-check"></i>&nbsp Reject</button>
          </div>
        </form>
        </div>
      </div>
