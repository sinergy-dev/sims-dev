    ...
    <div class="alert alert-success" id="alert">
      ...
      <div class="card mb-3">
        <div class="card-header">
           <i class="fa fa-table"></i>&nbsp<b>Daftar Buku Admin (PR)</b>
              ...
              <tbody id="products-list" name="products-list">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-sm btn-primary fa fa-pencil fa-lg" data-target="#modaledit" data-toggle="modal" style="width:50px; height:20px;vertical-align: top;" onclick="edit_pr('{{$data->no}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->from}}', '{{$data->issuance}}', '{{$data->project_id}}', '{{$data->note}}')">&nbsp Edit
                    </button>
                    @else
                    <button class="btn btn-sm btn-primary fa fa-pencil fa-lg disabled" data-target="#modaledit" data-toggle="modal" style="width:50px; height:20px;vertical-align: top;" onclick="edit_pr('{{$data->no}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->from}}', '{{$data->issuance}}', '{{$data->project_id}}', '{{$data->note}}')">&nbsp Edit
                    </button>
                    @endif
