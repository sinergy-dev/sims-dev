    ...
    <div class="alert alert-success" id="alert">
      ...
      <div class="card mb-3">
        <div class="card-header">
           <i class="fa fa-table"></i>&nbsp<b>Daftar Buku Admin (PO)</b>
           <div class="pull-right">
            ...
            <!-- <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
              ...
              <button class="btn btn-warning" style="height: 40px; margin-right: 10px;"><a href="{{url('/downloadExcelPO')}}"> EXCEL </a></button>
            <!-- </div> -->
          </div>
        </div>
        <div class="card-body">
              ...
              <tbody id="products-list" name="products-list">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-sm btn-primary fa fa-pencil fa-lg" data-target="#modaledit" data-toggle="modal" style="width:50px; height:20px;vertical-align: top;" onclick="edit_po('{{$data->no}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->from}}', '{{$data->issuance}}', '{{$data->project_id}}', '{{$data->division}}')">&nbsp Edit
                    </button>
                    @else
                    <button class="btn btn-sm btn-primary fa fa-pencil fa-lg disabled" data-target="#modaledit" data-toggle="modal" style="width:50px; height:20px;vertical-align: top;" onclick="edit_po('{{$data->no}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->from}}', '{{$data->issuance}}', '{{$data->project_id}}')">&nbsp Edit
                    </button>
                    @endif
