	...
	<section class="content">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs" id="myTab">
				...
				<li>
					<a href="#create" data-toggle="tab" class="createTab" onclick="makeNewTicket()">Create</a>
				</li>
				<li>
					<a href="#performance" data-toggle="tab" class="performanceTab" id="performanceTab" onclick="getPerformanceAll()">Performance</a>
				</li>
				<li>
					<a href="#setting" data-toggle="tab" class="settingTab">Setting</a>
				</li>
				<li>
					<a href="#reporting" data-toggle="tab" class="reportingTab">Reporting</a>
				</li>
				<!-- <li>
			...
			<div class="tab-content">
									...
									<div class="form-group">
										...
										<div>
											...
											<div class="input-group">
												<button type="button" class="btn btn-default btn-flat pull-left" style="width:100%" id="filterDashboardByDate">
												...
												<span class="input-group-addon">
					      						<a class="resetDate" onclick="reinitializeDateRangePicker()">
						...
						<div class="col-md-7 col-xs-12">
							<div class="table-responsive">
								<table class="table" style="border: solid 1px lightgray;width: 100%;" id="tb_sla_resolution_time">
									<thead>
									<tr>
										<th rowspan="3" style="text-align: center;vertical-align: middle;border-right: solid 1px lightgray;font-size: small;">
											Project ID
										</th>
										...
										<th colspan="3" rowspan="2" style="text-align: center;vertical-align: middle;font-size: small;">
											Total
										</th>
									</tr>
									<tr>
							...
							<form class="form-horizontal">
								...
								<div class="form-group" id="typeDiv" style="display: none;">
									...
									<div class="col-sm-4">
										...
										<span class="help-block" style="margin-bottom: 0px; display: none;">Type ticket must be fill!</span>
								...
								<div class="form-group" id="clientDiv" style="display: none;">
									...
									<div class="col-sm-4">
										...
										<span class="help-block" style="margin-bottom: 0px; display: none;">Client must be fill!</span>
								...
								<div class="form-group" id="pidDiv" style="display: none;">
									...
									<div class="col-sm-4">
										...
										<span class="help-block" style="margin-bottom: 0px; display: none;">Project ID must be select!</span>
									</div>
							...
							<div class="input-group">
								...
								<span class="input-group-btn">
									...
									<ul class="dropdown-menu" style="padding-left:5px;padding-right: 5px;" id="selectShowColumnTicket">
										...
										<li style="cursor: pointer;"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="14"><span class="text">Engineer</span></li>
									</ul>
									<button style="margin-left: 10px;" title="Refresh Table" id="reloadTable" type="button" class="btn btn-default btn-flat btn-sm">
										<i class="fa fa-fw fa-refresh"></i>
									</button>
									<button style="margin-left: 10px;" class="btn btn-success btn-flat btn-sm" id="exportTablePerformance"><i class="fa fa-file-excel-o"></i> Export to Excel</button>
								</span>
							</div>
						</div>
					</div>
				...
				<div class="tab-pane" id="setting">
					<div class="row form-group">
						<div class="col-md-9">
							<button class="btn btn-flat btn-sm btn-default" onclick="emailSetting()">
								Client Email Setting
							</button>
							<button class="btn btn-flat btn-sm btn-default" onclick="SlmEmailSetting()">
								SLM Email Setting
							</button>
							<button class="btn btn-flat btn-sm btn-default" onclick="userSetting()">
								User Setting
							</button>
							<button class="btn btn-flat btn-sm btn-default" onclick="SlaSetting()">
								SLA Setting
							</button>
						...
						<div class="col-sm-3 settingComponent" style="display: none" id="addEmail2">
							<div class="input-group">
								...
								<span class="input-group-btn">
									...
									<button class="btn btn-flat btn-sm btn-primary" onclick="EmailAdd()" id="addEmail" style="margin-left: 10px;display: none;">
										Add Email
									</button>
									<button class="btn btn-flat btn-sm btn-primary" onclick="EmailSlmAdd()" id="addEmailSlm" style="margin-left: 10px;display: none;">
										Add Email
									</button>
								</span>
							</div>
					...
					<div style="display: none" id="SlaSetting" class="row form-group settingComponent">
						<div class="col-md-12">
							<div class="table-responsive">
				...
				<div class="tab-pane" id="reporting">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<button id="ReportingButtonGo" class="pull-right btn btn-flat btn-sm btn-primary" style="display: none;" onclick="getReport()">
								Goo..
							</button>
							<button id="ReportingButtonGoNew" class="pull-right btn btn-flat btn-sm btn-primary" style="display: none;">
								Goo..
							</button>
							<button id="ReportingButtonGoNew2" class="pull-right btn btn-flat btn-sm btn-primary" style="display: none;">
								Goo..
							</button>
							<!-- </a> -->
						</div>
			...
			<div class="modal-dialog vertical-align-center">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modal-ticket-title">Update Progress before Close</h4>
					</div>
					<div class="modal-body">
						<form role="form">
							<div class="form-group">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-flat btn-primary" id="btnPendingClose">Update</button>
					</div>
				</div>
			</div>
		</div>
...
@section('script')
	<script type="text/javascript">
		...
		accesable.forEach(function(item,index){
			$("#" + item).show()
			if (accesable.includes('createTab') && accesable.includes('performanceTab') && accesable.includes('settingTab') && accesable.includes('reportingTab')) {
				$('.'+ item).hide()
			}
		})
					...
					success:function(result){
						...
						$.each(result.occurring_ticket,function(key,value){
							...
							if(value.activity == "OPEN")
								append = append + '<td><span class="label label-danger">' + value.activity + '</span></td>'
							else if(value.activity == "ON PROGRESS")
								append = append + '<td><span class="label label-info">' + value.activity + '</span></td>'
							else if(value.activity == "PENDING")
								append = append + '<td><span class="label label-warning">' + value.activity + '</span></td>'
							else if(value.activity == "CANCEL")
								append = append + '<td><span class="label bg-purple">' + value.activity + '</span></td>'
							else if(value.activity == "CLOSE")
								append = append + '<td><span class="label label-success">' + value.activity + '</span></td>'
					...
					if(this.value == ""){
						...
						$.ajax({
							...
							success: function(result){
								...
								if ($('#inputEngineerOpen').val() == "") {
									if (Array.isArray(result.engineers) && result.engineers.length > 0) {
										...
										selectEngineer.append(new Option('Other (Type Manually)', 'custom'));
										...
										selectEngineer.on('change', function () {
											if ($(this).val() === 'custom') {
												$(this).replaceWith('<input type="text" class="form-control" id="inputEngineerOpen" placeholder="" required>');
											}
										});
							...
							error: function(xhr, status, error) {
								...
								$("#inputATM").closest("div").addClass('has-error')
								$("#inputATM").next().next(".help-block").show().text(xhr.responseJSON.data).after("<a href='{{url('/ticketing#setting?Slm')}}' target='_blank'>here</a>")
								$("#inputLocation").val("");
								$("#inputType").val("");
								$("#inputSerial").val("");
								$("#slmDiv").hide();
							...
							dataSrc: function (json){
								json.data.forEach(function(data,idex){
									...
									if(data.lastest_activity_ticket.activity == "OPEN"){
										...
										data.lastest_status = '<span class="label label-danger">' + data.lastest_activity_ticket.activity + '</span> <p><small>'+ data.duration_from_last_activity + '</p></small>'
									} else if(data.lastest_activity_ticket.activity == "ON PROGRESS") {
										data.lastest_status_numerical = 2
										data.lastest_status = '<span class="label label-info">' + data.lastest_activity_ticket.activity + '</span> <p><small>'+ data.duration_from_last_activity + '</p></small>'
									} else if(data.lastest_activity_ticket.activity == "PENDING") {
										data.lastest_status_numerical = 3
										data.lastest_status = '<span class="label label-warning">' + data.lastest_activity_ticket.activity + '</span> <p><small>'+ data.duration_from_last_activity + '</p></small>'
									...
									//SLM Changes
									if(("{{Auth::user()->id_position}}" == "ENGINEER SPV" && data.request_pending == "1") || ("{{Auth::user()->id_position}}" == 'HELP DESK' && data.request_pending == "1")){
					...
					$.ajax({
						...
						success: function(data){
							if (Array.isArray(data) && data.length > 0) {
								...
								selectEngineer.on('change', function () {
									if ($(this).val() === 'custom') {
										$(this).replaceWith('<input type="text" class="form-control" id="ticketEngineer" placeholder="" required value="">');
									}
								});
		...
		function closePendingTicket(id,activity){
			if($("#saveNotePendingClose").val() == "" ){
				// $("#saveNotePendingClose, #startTimePendingClose, #endTimePendingClose, #datePendingClose").addClass('has-error')
				$("#saveNotePendingClose").parent().addClass('has-error')
				swalWithCustomClass.fire(
						'Error',
				...
				$("#startTimePendingClose").parent().addClass('has-error')
				swalWithCustomClass.fire(
						'Error',
				...
				$("#endTimePendingClose").parent().addClass('has-error')
				swalWithCustomClass.fire(
						'Error',
				...
				$("#datePendingClose").parent().addClass('has-error')
				swalWithCustomClass.fire(
						'Error',
					...
					columns:[
						...
						},
						{
							render: function ( data, type, row){
								return '<button type="button" class="btn btn-flat btn-sm btn-block btn-default" style="width:60" onclick="editClientEmail('+ row.id + ')">Edit</button>'
							},
							data:'action',
							className:'text-center',
							orderable: false,
			...
			if ($.fn.dataTable.isDataTable("#tableSlmEmailSetting")) {
				...
				$("#tableSlmEmailSetting").DataTable({
					...
					columns:[
						...
						{
							render: function ( data, type, row){
								return '<button type="button" class="btn btn-flat btn-sm btn-block btn-default" onclick="editSlmEmail('+ row.id + ')">Edit</button>'
							},
							className:'text-center',
							orderable: false,
							searchable: true,
			...
			if($.fn.dataTable.isDataTable("#tableAtm")){
				...
				$("#tableAtm").DataTable({
					ajax:{
						...
						dataSrc: function (json){
							json.data.forEach(function(data,idex){
								data.action = '<button type="button" class="btn btn-flat btn-sm btn-block btn-default" onclick="editAtm('+ data.id + ')">Edit</button>'
							})
							return json.data
						}
					},
