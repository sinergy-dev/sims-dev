  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="activable treeview">
        ...
        <ul class="activable treeview-menu" id="DVGPages">
          <li>
      ...
      <li class="activable treeview">
      	...
      	<ul class="activable treeview-menu" id="SalesPages">
      		...
      		<li class="activable treeview">
      			...
      			<ul class="activable treeview-menu" id="ReportLead">
      			<li>
      ...
      <li class="activable treeview">
        ...
        <ul class="activable treeview-menu" id="ADMINPages">
      ...
      <li class="activable treeview">
      	...
      	<ul class="activable treeview-menu" id="HumanResource">
      	  @if(Auth::User()->id_position == 'HR MANAGER')
      	  <li>
      ...
      <li class="activable treeview">
      	...
      	<ul class="activable treeview-menu" id="PMO">
      		<li>
      ...
      <li class="activable treeview">
        ...
        <ul class="activable treeview-menu" id="HRPages">
          <li>
      ...
      @if(Auth::User()->id_division == 'WAREHOUSE')
        <li class="activable treeview">
          ...
          <ul class="activable treeview-menu" id="INPages">
            <li>
