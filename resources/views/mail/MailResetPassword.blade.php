	...
	<div style="line-height: 1.5em;padding-left: 13px;">
		<div style="font-family: 'Montserrat','Helvetica Neue',Helvetica,Arial,sans-serif;">
			<p style="font-size: 20px">
				<p style="font-size: 16px">Hey, You are receiving this email because we received a password reset request for your account.</p>
			</p>
			<center><a href="{{$url}}" target="_blank"><button class="button">Reset Password</button></a></center>
