...
class PrMSPController extends Controller
{
    ...
    public function index()
    {
        ...
        $datas = DB::table('tb_pr_msp')
                        ...
                        ->select('no','no_pr', 'position', 'type_of_letter', 'month', 'date', 'to', 'attention', 'title', 'project', 'description', 'from', 'division', 'issuance', 'project_id', 'name')
                        ->get();

        return view('admin_msp/pr', compact('lead', 'total_ter','notif','notifOpen','notifsd','notiftp','id_pro', 'datas','notifClaim'));
    }
    ...
    /*public function PrAdmin()
    {
        ...
        $datas = DB::table('tb_pr')
                        ->select('no','no_pr', 'position', 'type_of_letter', 'month', 'date', 'to', 'attention', 'title', 'project', 'description', 'from', 'division', 'issuance', 'project_id')
                        ->get();

        return view('report/pr', compact('lead', 'total_ter','notif','notifOpen','notifsd','notiftp','id_pro', 'datas'));
    }*/
    ...
    /*public function PoAdmin()
    {
        ...
        return view('report/po', compact('lead', 'total_ter','notif','notifOpen','notifsd','notiftp','id_pro', 'datas'));
    }*/
